$(function () {
  ...
  function setup() {
    ...
    // example usage: createCollectable(type, x, y, gravity, bounce)
     createCollectable("Kyle", 155, 155, 0, 0.5)
     createCollectable("Eric", 1300, 225)
     createCollectable("Stan", 0, 700, 0, 0.5)
     createCollectable("Kenny", 800, 150, 0, 0.5)
